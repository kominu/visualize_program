...
void draw(){
  ...
  textAlign(LEFT);
  text_standard = box_size/15;
  text_s_height = text_standard*12/10;
  textSize(text_standard);
  if(mode == 1 || mode == 3 || mode == 4 || mode == 6){
    fill(0, 0, 10);
    text("PROTOCOL", height*0.45, -text_s_height*2);
    fill(300, 69, 9);
    text("TCP_SYN", height*0.45, 0);
    fill(30, 69, 9);
    text("TCP_SYN/ACK", height*0.45, text_s_height);
    fill(180, 69, 9);
    text("TCP_ACK", height*0.45, text_s_height * 2);
    fill(0, 69, 9);
    text("TCP_RST", height*0.45, text_s_height * 3);
    fill(270, 69, 9);
    text("TCP_FIN", height*0.45, text_s_height * 4);
    fill(240, 69, 9);
    text("TCP_OTHER", height*0.45, text_s_height * 5);
    fill(120, 69, 9);
    text("UDP", height*0.45, text_s_height * 7);
    fill(60, 69, 9);
    text("ICMP", height*0.45, text_s_height * 9);
    fill(0, 0, 10);
    text("OTHERS", height*0.45, text_s_height * 11);
  }else if(mode == 2 || mode == 5){
    fill(0, 0, 10);
    text("PORT", height*0.45, -text_s_height * 2);
    fill(300, 0, 10);
    text("http", height*0.45, 0);
    fill(300, 0, 10);
    text("https", height*0.45, text_s_height);
    fill(0, 69, 9);
    text("O", height*0.45, text_s_height * 3);
    fill(60, 69, 9);
    text("T", height*0.45 + 20, text_s_height * 3);
    fill(120, 69, 9);
    text("H", height*0.45 + 40, text_s_height * 3);
    fill(180, 69, 9);
    text("E", height*0.45 + 60, text_s_height * 3);
    fill(240, 69, 9);
    text("R", height*0.45 + 80, text_s_height * 3);
    fill(300, 69, 9);
    text("S", height*0.45 + 100, text_s_height * 3);
    fill(0, 0, 10);
  }
  popMatrix();
